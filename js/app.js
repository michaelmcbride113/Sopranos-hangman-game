...
const updateHangman = () => {
    if (remainingGuesses === 6) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215173028/0.png" alt="Gallows" width="250" height="300" />`;
    } else if (remainingGuesses === 5) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215173033/1.png" alt="Hangman head" width="250" height="300" />`;
    } else if (remainingGuesses === 4) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215173038/2.png" alt="Hangman body" width="250" height="300" />`;
    } else if (remainingGuesses === 3) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215172733/3.png" alt="Hangman arm 1" width="250" height="300" />`;
    } else if (remainingGuesses === 2) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215173815/4.png" alt="Hangman arm 2" width="250" height="300" />`;
    } else if (remainingGuesses === 1) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215173859/5.png" alt="Hangman leg 1" width="250" height="300" />`;
    } else if (remainingGuesses === 0) {
        hangmanPiecesEl.innerHTML = `<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240215173931/6.png" alt="Hangman leg 2" width="250" height="300" />`;
    }
};
